...
- This subtree owns service integrations and domain API clients for `boringNotch/Services`.
- Keep this file current when responsibilities, contracts, or child docs change.

## Ownership

- Applies to every file under `boringNotch/Services` unless a deeper AGENTS.md overrides it.
